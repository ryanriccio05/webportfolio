...
/*****************************************************************/
	...
	function Player() {
		...
		this.flipCards = function() {
            ...
            $('#dscore').html("Dealer's Score: " + dealer.getScore());
		};
	}
...
/*****************************************************************/
	...
	Player.prototype.updateBoard = function() {
        if(this === player) {
            $('#pscore').html("Your Score: " + this.getScore());
        } else {
            $('#dscore').html("Dealer's Score: " + this.getScore());
        }
...
/*****************************************************************/
	...
	function showBoard() {
        ...
        // Always refresh scores after the initial deal
        player.updateBoard();
    
        // Hide dealer's second card, only show first card value
        $('#dscore').html("Dealer's Score: " + dealer.getHand()[0].value);
    }
